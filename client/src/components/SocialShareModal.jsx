...
export default function SocialShareModal({ setShowSSModal, shortUrl }) {
    ...
    const handleCloseModal = () => {
      ...
      const handleFacebookShare = () => {
        const url = `https://www.facebook.com/sharer.php?u=${encodeURIComponent("www.google.lk")}`;
      ...
      {setShowSSModal ? (
        ...
        <div class="my-4">
          ...
          <div class="border-2 border-gray-200 flex justify-between items-center mt-4 py-2">
            ...
            <input class="w-full outline-none bg-transparent" type="text" placeholder="link" value="https://boxicons.com/?query=link"></input>
